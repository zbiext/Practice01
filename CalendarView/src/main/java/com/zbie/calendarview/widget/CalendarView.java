...
import com.zbie.calendarview.utility.CalendarUtility;
...
public class CalendarView extends LinearLayout {
    ...
    private void init() {
        ...
        // mBackButton.setImageTintMode(PorterDuff.Mode.CLEAR);
    ...
    private void initTitleLayout() {
        ...
        dateTitle.setText(toCamelCase(dateText));
    ...
    private void initWeekLayout() {
        ...
        //mContext.getResources().getStringArray(R.array.weekdays);//new DateFormatSymbols(getLocale()).getShortWeekdays();
        for (int i = 1; i < weekDaysArray.length; i++) {
            dayOfTheWeekString = weekDaysArray[i];
            //int length = dayOfTheWeekString.length() < 3 ? dayOfTheWeekString.length() : 3;
            // dayOfTheWeekString = dayOfTheWeekString.substring(0, dayOfTheWeekString.length());
    ...
    public void setCurrentDay(@NonNull Date todayDate) {
        ...
        if (CalendarUtility.isToday(calendar)) {
            ...
            dayOfMonth.setBackgroundColor(Color.parseColor("#69000000"));
        }
    }
    ...
    public void setDateAsSelected(Date currentDate) {
        ...
        view.setBackgroundColor(Color.parseColor("#69000000"));
